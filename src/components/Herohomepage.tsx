        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1.5 text-sm font-medium text-primary">
              ...
              New: AI-Powered Problem Solving
            </div>

            {/* Headline */}
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Master Advanced Mathematics with
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Transform your mathematical understanding with personalized instruction from PhD-level educators. From calculus to advanced statistics, we make complex concepts clear.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button size="lg" variant="outline" className="text-base">
                <Play className="mr-2 size-5" /> Watch Sample Lesson
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Advanced mathematics tutoring session"
                  fill
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">94%</span> Grade Improvement
              </p>
            </div>
